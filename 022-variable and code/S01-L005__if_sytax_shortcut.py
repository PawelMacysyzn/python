...
print("You are doing laundry") if today_weekday == 'Tuesday' or today_weekday == 'Wednesday' else \
print("I'm on duty") if today_weekday == 'Thursday' else \
print("I have two meetings") if today_weekday == 'Friday' else \
print("You have lessons") if today_weekday == 'Saturday' else \
print("SUNDAY WILL BE FOR US")
